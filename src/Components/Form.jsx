    ...
    <form className="md:mx-5  md:w-80 md:my-4">
      <div className="md:w-full">
        <TextField
          ...
          helperText={
            formSubmitted && !formData.name.trim() ? 'Name is required' : null
          }
        />
      </div>
      <br />
      ...
      <div className="">
        <TextField
          ...
          helperText={
            formSubmitted && !formData.email.trim() ? 'Email is required' : null
          }
        />
      </div>
      <br />
      ...
      <div className="">
        <TextField
          ...
          helperText={
            formSubmitted && !formData.phone.trim() ? 'Phone is required' : null
          }
        />
      </div>
      <br />
      ...
      <div className="flex place-content-center pt-8  md:pt-8">
        <input
          ...
          className="px-8 text-blue-500 rounded-md py-2 border-2 border-ash"
          type="submit"
          value={'Submit'}
        />
      </div>
      <div className=" md:pt-5 pt-5 flex justify-center items-center ">
        {dataSent && (
          <span className="text-xs bg-slate-200 rounded-sm px-2 py-1 text-green-900 font-medium">
            {' '}
