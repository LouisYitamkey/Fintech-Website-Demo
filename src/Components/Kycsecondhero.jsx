...
const Kycsecondhero = () => {
  return (
    ...
    <section id="home" className={`flex md:px-28  md:flex-row  flex-col  pt-5 md:pt-0 md:py-20  ` }>
     ...
     <div>
     <span className='md:text-xl text-base ml-3  bg-sky-500 px-5 rounded-full text-white  md:font-bold '> Instant Verification </span> 
       ...
       <h1 className='md:text-7xl md:hidden pb-10 pt-6 text-[#093554] text-4xl  md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] '>From 3 days to 3 clicks </h1>
