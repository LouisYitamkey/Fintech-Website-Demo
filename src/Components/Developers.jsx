...
const Developers = () => {
  return (
    <div className='md:pt-10 pt-5 pb-20 md:pb-0   px-3 bg-slate-100 '>
      <h1 className='text-center md:pt-14'>  <span className='md:text-xl text-2xl pl-3 bg-sky-500 px-5    rounded-full text-white  md:font-bold '> Credit Infrastructure</span> </h1>
