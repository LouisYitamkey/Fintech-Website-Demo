...
<div>
<span className='md:text-xl text-base ml-3  bg-sky-500 px-5    rounded-full text-white  md:font-bold '> Global Connectivity</span> 
 ...
 <h1 className='md:text-7xl md:hidden pb-10 pt-6 text-[#093554] text-4xl pl-3 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] '> Grow with us </h1>
