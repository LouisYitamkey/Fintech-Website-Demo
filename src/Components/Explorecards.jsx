...
const Explorecards = () => {
  ...
  return (
    <div className='py-12 md:py-20 md:pt-16 md:px-52 md:pb-20  w-full'>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 pl-3 md:pl-0  md:space-x-40 '>
        ...
        <p className='text-xl text-decoration  decoration-1 underline md:no-underline  md:hover:underline underline-offset-8  text-[#f7ab1b]  pb-5 md:pb-0 pt-5 font-bold  hover:cursor-pointer md:pt-2'> Explore Crypto  <i class="fa-solid fa-chevron-right"></i></p>
        ...
        <p className='text-xl text-decoration  decoration-1 underline md:no-underline  md:hover:underline underline-offset-8  text-[#f7ab1b]  pb-5 md:pb-0 pt-5 font-bold  hover:cursor-pointer md:pt-2'> Explore Finance  <i class="fa-solid fa-chevron-right"></i></p>
        ...
        <div className=''>
               ...
               <p className='text-xl text-decoration underline md:no-underline decoration-1  md:hover:underline underline-offset-8  text-[#f7ab1b]  pb-5 md:pb-0 pt-5 font-bold hover:cursor-pointer md:pt-2'> Explore Investment  <i class="fa-solid fa-chevron-right"></i></p>
               </div>
