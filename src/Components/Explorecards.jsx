...
const Explorecards = () => {
  ...
  return (
    ...
    <span className='md:text-xl text-base ml-3  bg-sky-500 px-5    rounded-full text-white  md:font-bold '> Industry focused</span> 
    ...
    <h1 className='md:text-7xl md:hidden pb-5 pt-6  text-4xl  md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] '> Build better payments <br/> experiences </h1>
    </div>
