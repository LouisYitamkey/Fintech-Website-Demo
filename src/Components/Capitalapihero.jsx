          ...
          >
            <div className="flex flex-row items-center py-[6px]  md:pl-28 bg-discount-gradient rounded-[10px] mb-2">
              <div>
                ...
                <p className="font-normal pl-3 md:hidden   text-lg">
                  From term loans of credit and everything in between, our
                  marketplace of specialized lenders across multiple industries
                  gives your customers easier, faster access to capital{' '}
                </p>
                <span className="font-normal hidden md:block    text-lg">
                  From term loans of credit and everything in between, our
                  marketplace of specialized lenders across multiple industries
                  gives your customers easier, faster access to capital{' '}
                </span>
                ...
                <div className="md:mt-10 mt-10 mb-5 ">
                  <div className=" hidden md:block mt-10 md:mt-10 space-x-5 ">
                    ...
                    >
                      {' '}
                      See a Demo <BiChevronRight size={30} />{' '}
                    </Button>
                    <Button
