...
export function FeaturesGrid({ title, description, data = MOCKDATA }) {
  ...
  return (
    <Container className={classes.wrapper}>
      <Title className='md:text-2xl text-xl   md:pl-1 text-[#093554]  md:font-bold text-center'>{title}</Title>

      <Container size={560} p={0}>
        <Text size="sm" className='md:text-5xl text-center hidden md:block text-[#093554] md:py-6  text-4xl pl-10 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[39px] md:leading-[50px] '>
          {description}
        </Text>
      </Container>
