            ...
            >
              <div className="flex flex-row items-center   md:pl-28 bg-discount-gradient rounded-[10px] mb-2">
                <div>
                  ...
                  <h1 className="md:text-7xl md:hidden pb-10 pt-5 text-[#093554] text-4xl  md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] ">
                    {' '}
                    The complete solution{' '}
                  </h1>
