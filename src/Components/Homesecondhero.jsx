...
<video  className='w-80 border-8  rounded-3xl border-slate-200 ' autoPlay muted loop src={Secondvideo} />
    ...
    <p className='font-normal pl-3 md:hidden  text-[#849aa9]  text-lg'>Onboard customers in seconds and securely access account information. <br className='hidden md:block'/> Say goodbye to manual form-filling and accelerate  KYC    <br className='hidden md:block'/> processes.</p>
    <span className='font-normal hidden md:block text-[#849aa9]   text-lg'>Onboard customers in seconds and securely access account information.  Say goodbye to manual form-filling and accelerate your AML and KYC    processes.</span>
