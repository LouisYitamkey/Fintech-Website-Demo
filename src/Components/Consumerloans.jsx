...
const Consumerloans = () => {
  return (
    <div className="w-full h-full bg-slate-100 py-10 md:py-0 ">
      <section
        id="home"
        className={`flex md:px-28  md:flex-row  flex-col  md:py-20  `}
      >
              ...
              <div className="flex flex-row items-center   md:pl-28 bg-discount-gradient rounded-[10px] mb-2">
                <div>
                  <span className="md:text-xl text-base ml-3  bg-sky-500 px-5    rounded-full text-white  md:font-bold ">
                    {' '}
                    Consumer loans in your own branding
                  </span>
                  ...
                  <span className="font-normal md:pb-5 text-[#849aa9]   text-lg">
                    Powered by machine learning, we’ve built a name-matching
                    engine on <br className="hidden md:block" /> top of open
                    banking rails. This allows you to instantly and accurately{' '}
                    <br /> verify users, without having to process streams of
                    raw bank data yourself.{' '}
                  </span>
                  ...
                  <div className=" ">
                    ...
                    <div>
                      <p className="font-normal  pl-3 md:pl-0 md:pt-8 pt-6 md:pb-0  text-lg">
                        {' '}
