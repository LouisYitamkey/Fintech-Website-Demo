...
<div>
 ...
 <h1 className=' hidden md:block md:text-5xl md:pt-5  text-[#093554] md:pb-10 tracking-wide text-4xl pl-10 md:pl-0   ss:leading-[100.8px] leading-[39px] md:leading-[50px] font-extrabold '> Make onboarding <br/> intuitive </h1>
 <h1 className='md:text-7xl md:hidden pb-10 pt-2 text-[#093554] text-4xl pl-3 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] '> Make onboarding intuitive </h1>
...
<video  className='w-full px-4 ' autoPlay muted loop src={Secondvideo} />
 ...
 <p className='font-normal pl-3 md:pl-0 text-[#849aa9]        text-lg'>Bank statements uploads and micro-deposits are <br/> prone to errors and take forever. Combining open <br/> banking with machine learning, <span className='font-semibold'>  Verification  </span><br/> delivers a faster onboarding experience, with 90%+ <br/>
