...
const Intuitive = () => {
  return (
    <div className="w-full pt-10 md:pt-0 bg-[#11243e] text-white ">
      <section
        id="home"
        className={`flex md:px-28  md:flex-row  flex-col sm:py-32 py-6`}
      >
        <div
        ...
        >
          <div className="flex flex-row items-center py-[6px]  md:pl-28 bg-discount-gradient rounded-[10px] mb-2">
            <div>
              <h1 className=" hidden md:block md:text-5xl md:pt-5   md:pb-10 tracking-wide text-4xl pl-10 md:pl-0   ss:leading-[100.8px] leading-[39px] md:leading-[50px] font-extrabold ">
                {' '}
                Make onboarding <br /> intuitive{' '}
              </h1>
              <h1 className="md:text-7xl md:hidden pb-10 pt-2 text-4xl pl-3 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[40px] md:leading-[60px] ">
                {' '}
              ...
              <p className="font-normal pl-3 md:pl-0 text-slate-200        text-lg">
                Bank statements uploads and micro-deposits are <br /> prone to
                errors and take forever. Combining open <br /> banking with
                machine learning,{' '}
                <span className="font-semibold"> Verification </span>
                <br /> delivers a faster onboarding experience, with 90%+ <br />
                good actors successfully verified in three clicks.
              </p>
              <div>
                <p className="font-normal pl-3 md:pl-0 md:pt-6 pt-6 md:pb-  text-lg">
                  {' '}
                  <span>
                    {' '}
                    <i class="fa-solid fa-square-check"></i>{' '}
                  </span>{' '}
                  &nbsp; Live across the UK, Europe, and Australia
                </p>
              </div>
              <div>
              ...
              <div className="pt-10 hidden md:block">
                <Button className=" bg-sky-600 hover:bg-sky-500 text-base     text-white px-6 py-3 ">
                  {' '}
                  Contact Sales <BiChevronRight size={25} />{' '}
                </Button>
              </div>
              {/* For Mobile */}
