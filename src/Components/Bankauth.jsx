...
const Bankauth = () => {
  return (
    <div className="w-full pt-20 md:pt-0 pb-10 md:pb-0 md:mt-0  bg-[#11243e]  ">
      <section
        id="home"
        className={`flex md:px-28  md:flex-row  flex-col sm:py-16 `}
      >
        <div
        ...
        >
          <div className="flex flex-row items-center   md:pl-28 bg-discount-gradient rounded-[10px] mb-2">
            <div>
              ...
              <h1 className=" hidden md:block md:text-5xl md:pt-5 text-white md:pb-10 tracking-wide text-4xl pl-10 md:pl-0   ss:leading-[100.8px] leading-[39px] md:leading-[50px] font-extrabold ">
                {' '}
                Slash your fraud risk{' '}
              </h1>
              <h1 className="md:text-7xl md:hidden pb-10 pt-5 text-white text-4xl pl-3 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] ">
                {' '}
                Slash your fraud risk
              </h1>
              ...
              <p className="font-normal pl-3 md:pl-0 text-slate-200   text-lg">
                {' '}
                Guarantee source and destination of funds. Verification
                introduces Strong Customer Authentication checks from the bank
                into your verification flow to combat identity theft.
              </p>
              <div>
                <p className="font-normal pl-3 md:pl-0 md:pt-6 pt-6 text-white  text-lg">
                  {' '}
              ...
              <div>
                <p className="font-normal pl-3 md:pl-0 md:pt-4 text-white  pt-4  text-lg">
                  {' '}
                  <span className="text-white">
                    {' '}
                    <i class="fa-solid fa-square-check"></i>{' '}
              ...
              <div className=" hidden md:block mt-10 md:mt-10 space-x-5  ">
                <Button className=" bg-sky-600 hover:bg-sky-500 text-base     text-white px-6 py-3 ">
                  {' '}
                  See How It Works <BiChevronRight size={25} />{' '}
                </Button>
                <Button
