...
const Homethirdhero = () => {
  return (
    ...
    <section id="home" className={`flex md:px-28  md:flex-row  flex-col ${styles.paddingY}`}>
     ...
     <div>
    <span className='md:text-xl text-xl    md:pl-1 text-[#7991a2]  md:font-bold '> Enhanced KYC</span> 
       <h1 className='md:text-5xl hidden md:block text-white md:py-6 tracking-wide text-4xl pl-10 md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[39px] md:leading-[50px] '>The easiest way to <br/> Verify and Onboard <br/> users. </h1>
       <h1 className='md:text-7xl md:hidden pb-10 pt-2 text-white text-4xl  md:pl-0 font-extrabold md:font-bold ss:leading-[100.8px] leading-[30px] md:leading-[60px] '> The easiest way to Verify and Onboard users. </h1>
       <div className='md:hidden mb-10 flex items-center justify-center'>

<video  className='w-80 border-8  rounded-3xl border-slate-200 ' autoPlay muted loop src={Secondvideo} />

    </div>
       <span className='  text-white  text-lg'> Verify Phone Numbers, ID Cards, and Addresses.  Verify  <br className='hidden md:block'/> the user’s consent  in real-time with consent verification. <br className='hidden md:block'/> Know that people are who they say they are, Faster.
 </span>
...
{/* First */}
    ...
    <div>
      ...
      <p className=' md:pl-1 pl-3 text-white  hover:text-blue-300  '> Phone Number Verification </p> 
...
<p className='text-white hover:text-sky-500 pl-3  md:pl-1  '> ID Verification </p>
...
<p className='text-white hover:text-sky-500 pl-3 md:pl-1  '> Address Verification (Location, Utility Bill) </p>
